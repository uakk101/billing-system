...
const GenerateBillPopup = ({ onClose, billID, fetchData }) => {
  ...
  const [validationModel, setValidationModel] = useState({
    ...
    cChannel1Error: null,
    cChannel1QError: null,
    cChannel1PError: null,
    cChannel1TError: null,
  ...
  const setValidation = () => {
    let validation_Obj = {
      ...
      cChannel1Error: Validator(
        locationModel.cChannel1,
        [V_Type.required],
        ["it is required"]
      ),
      cChannel1QError: Validator(
        locationModel.cChannel1Q,
        [V_Type.required],
        ["it is required"]
      ),
      cChannel1PError: Validator(
        locationModel.cChannel1P,
        [V_Type.required],
        ["it is required"]
      ),
  ...
  const deleteItem = (index) => {
    setLocationModel((prevState) => ({
      ...prevState,
      panelInstallStructure: prevState.panelInstallStructure.filter(
        (_, i) => i !== index
      ),
    }));
  ...
  return (
    ...
    <div
      data-te-modal-init
      className="fixed left-0 top-0 z-[10] h-full w-full overflow-y-auto overflow-x-hidden outline-none"
      ...
      >
        <div className="pointer-events-auto p-5 relative flex justify-between max-h-[100%] w-full flex-col overflow-hidden rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
          ...
          <div className="relative overflow-y-auto">
              ...
              <div className="bg-white ">
                ...
                <div className="grid grid-cols-12 gap-4 px-4">
                  ...
                  <div className="col-span-12 md:col-span-2">
                    <CustomInput
                      name={"cChannel1"}
                      value={locationModel.cChannel1}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.cChannel1Error}
                  </div>
                  <div className="col-span-12 md:col-span-4">
                    <CustomInput
                      name={"cChannel1Q"}
                      value={locationModel.cChannel1Q}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.cChannel1QError}
                  </div>
                  <div className="col-span-12 md:col-span-4">
                    <CustomInput
                      name={"cChannel1P"}
                      value={locationModel.cChannel1P}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.cChannel1PError}
                  </div>
                  <div className="col-span-12 md:col-span-2">
                    <h1 className="mt-2 text-end">
                      {Number(
                        locationModel.cChannel1Q * locationModel.cChannel1P
                      ).toFixed(2)}
                    </h1>
                  </div>
                  {/*  */}
                  ...
                  <div className="col-span-12 md:col-span-2">
                    <CustomInput
                      name={"L3"}
                      value={locationModel.L3}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.L3Error}
                  </div>
                  <div className="col-span-12 md:col-span-4">
                    <CustomInput
                      name={"L3Q"}
                      value={locationModel.L3Q}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.L3QError}
                  </div>
                  <div className="col-span-12 md:col-span-4">
                    <CustomInput
                      name={"L3P"}
                      value={locationModel.L3P}
                      onChange={onhandleChange}
                      type="text"
                      required={true}
                    />
                    {validationModel.L3PError}
                  </div>
                  <div className="col-span-12 md:col-span-2">
                    <h1 className="mt-2 text-end">
                      {Number(locationModel.L3Q * locationModel.L3P).toFixed(2)}
                    </h1>
                  </div>
                  {/*  */}
            ...
            <div className="">
              {locationModel.panelInstallStructure &&
                locationModel.panelInstallStructure.map((item, index) => (
                  <div
                    className="grid grid-cols-12 gap-4 px-4 py-2"
                    key={index}
                  >
                    <div className="col-span-12 md:col-span-2">
                  ...
                  <h1 className="mt-2 text-2xl text-green-700 text-end">
                    {(
                      ((locationModel.panelInstallStructure &&
                        ...
                        0) + parseFloat(locationModel.otherExpenses || 0)
                    ).toFixed(2)}
                  </h1>
                </div>
              </div>
